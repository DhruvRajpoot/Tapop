...
import {ModalWrapper, CloseButton, Description, FileInput, Form, Heading, Input, InputWrapper, Label,SubmitButton, ThankYou, ThankYouWrapper} from "./ModalStyle";
...
const ModalJs = () => {
  ...
  return (
    <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles}>
        <CloseButton onClick={closeModal} title="close"> <AiFillCloseSquare /></CloseButton>
